...
namespace Entidades.Clases
{
    ...
    {
        public Paciente(string nombre, string apellido,int id_tipoDoc,long nroDoc,int id_domicilio,long telefono,long nroCelular,string mail,int id_usuario,int id_estado)
