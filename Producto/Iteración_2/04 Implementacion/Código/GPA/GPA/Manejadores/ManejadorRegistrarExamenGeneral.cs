...
namespace GPA.Manejadores
{
    public class ManejadorRegistrarExamenGeneral
    {
        ...
        {
            pantalla.presentarExamenGeneral(ExtremidadLN.mostrarExtremidades(), PosicionLN.mostrarPosiciones(), SitioMedicionLN.mostrarSitiosDeMedicion(), MomentoDiaLN.mostrarMomentosDelDia());
        }
        ...
        public void registrarMedicionDePresionArterial()
        {
            if (medicion.mediciones != null && medicion.mediciones.Count > 0)
            {
                MedicionDePresionArterialLN.registrarMedicionDePresionArterial(medicion);
            }
        }
    }
}
