...
namespace GPA.Manejadores
{
    public class ManejadorRegistrarProfesionalMedico
    {
        ...
        {
            List<ProfesionaMedico> profesionales = ProfesionalMedicoDAO.buscarProfesionalMédico(id_tipoDoc, nro_documento);
            if (profesionales.Count != 0)
            {
                ProfesionaMedico profesional = profesionales.ElementAt(0);
