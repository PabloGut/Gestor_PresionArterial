...
namespace DAO
{
    public class SintomaDAO
    {
        ...
        public static void registrarSintomasDeConsulta(Sintoma sintoma, SqlConnection cn, SqlTransaction tran)
        {
            try
            {
                string consulta = @"insert into Sintoma(fechaInicioSintoma,cantidadDeTiempo,id_elementoDelTiempo_fk,id_descripcionDelTiempo_fk,id_tipoSintoma_fk,descripcion,id_parteDelCuerpo_fk,haciaDondeIrradia,id_comoSeModifica_fk,id_elementoDeModificacion_fk,id_caracterDolor_fk,observaciones,fechaRegistro,id_consulta_fk)
                                  values(@fechaInicioSintoma,@cantidadTiempo,@idElementoTiempo,@idDescripcionTiempo,@idTipoSintoma,@descripcion,@idParteCuerpo,@haciaDondeIrradia,@idComoModifica,@idElementoModificacion,@idCaracterDolor,@observaciones,@fechaRegistro,@id_consulta_fk)";
        ...
        public static void registrarSintomasDeConsulta(List<Sintoma> sintomas, int idConsulta)
        {
            ...
            try
            {
                ...
                foreach (Sintoma sintoma in sintomas)
                {
                    ...
                    cmd.Parameters.AddWithValue("@fechaRegistro", sintoma.fechaRegistro.ToShortDateString());
                    cmd.Parameters.AddWithValue("@id_consulta_fk", idConsulta);
