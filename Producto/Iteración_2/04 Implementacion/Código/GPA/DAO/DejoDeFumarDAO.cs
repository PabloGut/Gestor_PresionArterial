...
namespace DAO
{
    public class DejoDeFumarDAO
    {
        ...
        public static void registrarDejoDeFumar(DejoDeFumar dejoFumar, SqlTransaction tran, SqlConnection cn)
        {
            try
            {
                string consulta = @"insert into DejoDeFumar(cantidadDeTiempo,id_elementoDelTiempo_fk,id_descripcionDelTiempo_fk, cantidadFumaba, id_elementoQueFuma_fk, id_componenteTiempo_fk, id_habitoTabaquismo_fk)
