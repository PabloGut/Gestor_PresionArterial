...
namespace DAO
{
    public class RazonamientoDiagnosticoDAO
    {
        ...
        public static void updateRazonamientoDiagnostico(RazonamientoDiagnostico razonamientoDiagnostico, SqlConnection cn, SqlTransaction tran)
        {
            SqlCommand cmd = new SqlCommand();
            ...
            try
            {
                ...
                if (razonamientoDiagnostico.tratamientosACancelar != null && razonamientoDiagnostico.tratamientosACancelar.Count > 0)
                {
                    foreach (Tratamiento tratamiento in razonamientoDiagnostico.tratamientosACancelar)
                    {
                        tratamiento.id_razonamiento_fk = razonamientoDiagnostico.id_razonamiento;
                        TratamientoDAO.cancelarTratamiento(tratamiento, cn, tran);
                    }
                }
